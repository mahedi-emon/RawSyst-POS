...
import (
	...
	"github.com/mahedi-emon/Biz1core/backend/internal/devices"
	...
	"github.com/mahedi-emon/Biz1core/backend/internal/fiscal"
	"github.com/mahedi-emon/Biz1core/backend/internal/fx"
	"github.com/mahedi-emon/Biz1core/backend/internal/group"
	...
	"github.com/mahedi-emon/Biz1core/backend/internal/platform/metrics"
	"github.com/mahedi-emon/Biz1core/backend/internal/platform/observe"
	...
	"github.com/mahedi-emon/Biz1core/backend/internal/sync"
...
func (s *Server) Routes() []Route {
	return []Route{
		...
		{http.MethodGet, "/api/v1/eosb", AccessPermission, "payroll.view",
			...
			"what has been PROVIDED FOR each person: the sum of the monthly charges. Not what is owed on leaving, which is Article 84 on the last wage and is the settlement route below"},
		...
		{http.MethodGet, "/api/v1/eosb/settlement/{employeeID}", AccessPermission, "payroll.view",
			s.handleEOSBSettlement,
			"the statutory award owed to one person on leaving, with its working: Article 84 across both service bands on the last wage, and Article 85's fraction when they resigned"},
		...
		{http.MethodPost, "/api/v1/platform/jurisdictions/rates/activate",
			AccessSuperAdmin, "", s.handleActivateRates,
			"makes an imported schedule usable after checking provenance and the authority chain; review and verification stay available as internal controls"},
